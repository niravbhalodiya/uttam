            ...
            <div className="grid min-h-screen max-w-screen-xl place-content-center px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
                <div className="mr-auto place-self-center lg:col-span-7">
                    ...
                    <div className="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                        <Link to={'/challenges/ask'} className="inline-flex min-w-[200px] items-center justify-cejustify-startnter gap-4 w-full px-5 py-3 text-sm font-medium text-center text-gray-900 border border-gray-200 rounded-lg sm:w-auto hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 ">
